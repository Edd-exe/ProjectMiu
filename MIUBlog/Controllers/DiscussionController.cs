...
namespace MIUDiscussion.WebUI.Controllers
{
    public class DiscussionController : Controller
    {
       ...
       // [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create(Discussion entity)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("UserDiscussionList");
            }
            ViewBag.Categories = new SelectList(_categoryService.GetAll(), "CategoryId", "Name");
            return View(entity);
        }
      ...
      //  [Authorize(Roles = "Admin")]
        ...
        {
            var result = _discussionService.Get(id);
    ...
    //    [Authorize(Roles = "Admin")]
        public IActionResult DeleteConfirmate(int Id)
        {
            try
            {
                var result = _discussionService.Get(Id);
      ...
      //  [Authorize(Roles = "Admin")]
        ...
        public async Task<IActionResult> UserDiscussionList()
        {
            ApplicationUser user = await _userManager.FindByNameAsync(User.Identity.Name);
